#!/usr/bin/env python3
"""Generate a chessboard calibration board."""
...
# 黑色棋盘格凸起高度。STEP 总高度 = BASE_THICKNESS_MM + BLACK_HEIGHT_MM。
BLACK_HEIGHT_MM = 0.5
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Generate chessboard calibration board PNG/SVG/DXF/STEP assets.",
